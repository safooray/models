...
_IMAGERESIZER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scale_resizer', full_name='object_detection.protos.ImageResizer.scale_resizer', index=2,
...
_SCALERESIZER = _descriptor.Descriptor(
  name='ScaleResizer',
  full_name='object_detection.protos.ScaleResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='scale', full_name='object_detection.protos.ScaleResizer.scale', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resize_method', full_name='object_detection.protos.ScaleResizer.resize_method', index=1,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='convert_to_grayscale', full_name='object_detection.protos.ScaleResizer.convert_to_grayscale', index=2,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMAGERESIZER.fields_by_name['scale_resizer'].message_type = _SCALERESIZER
...
_IMAGERESIZER.oneofs_by_name['image_resizer_oneof'].fields.append(
  _IMAGERESIZER.fields_by_name['scale_resizer'])
_IMAGERESIZER.fields_by_name['scale_resizer'].containing_oneof = _IMAGERESIZER.oneofs_by_name['image_resizer_oneof']
...
_SCALERESIZER.fields_by_name['resize_method'].enum_type = _RESIZETYPE
...
DESCRIPTOR.message_types_by_name['ScaleResizer'] = _SCALERESIZER
...
ScaleResizer = _reflection.GeneratedProtocolMessageType('ScaleResizer', (_message.Message,), dict(
  DESCRIPTOR = _SCALERESIZER,
  __module__ = 'object_detection.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.ScaleResizer)
  ))
_sym_db.RegisterMessage(ScaleResizer)
